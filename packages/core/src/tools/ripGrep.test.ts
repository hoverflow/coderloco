...
describe('RipGrepTool', () => {
  ...
  describe('execute', () => {
    ...
    it('should pass .locoignore to ripgrep when respected', async () => {
      await fs.writeFile(
      ...
      mockSpawn.mockImplementationOnce(
        createMockSpawn({
          ...
          onCall: (_, args) => {
            ...
            expect(args).toContain(path.join(tempRootDir, '.locoignore'));
          },
        }),
      );
    ...
    it('should include .locoignore matches when disabled in config', async () => {
      await fs.writeFile(path.join(tempRootDir, '.locoignore'), 'kept.txt\n');
      ...
      mockSpawn.mockImplementationOnce(
        createMockSpawn({
          ...
          onCall: (_, args) => {
            ...
            expect(args).not.toContain(path.join(tempRootDir, '.locoignore'));
          },
        }),
      );
