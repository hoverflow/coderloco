 ...
 * - 'project': Stored in `.loco/agents/` within the project directory
 * - 'user': Stored in `~/.loco/agents/` in the user's home directory
...
export interface ModelConfig {
  /**
   * The name or identifier of the model to be used (e.g., 'loco3-coder-plus').
   *
