...
import type { RumEvent } from './loco-logger/event-types.js';
...
describe('Circular Reference Integration Test', () => {
  ...
  it('should handle HttpsProxyAgent-like circular references in LOCO logging', () => {
    ...
    // Test that locoLogger can handle this
