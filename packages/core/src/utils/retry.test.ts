...
describe('retryWithBackoff', () => {
  ...
  describe('LOCO OAuth 429 error handling', () => {
    it('should retry for LOCO OAuth 429 errors that are throttling-related', async () => {
    ...
    it('should throw immediately for LOCO OAuth with insufficient_quota message', async () => {
      ...
      await expect(promise).rejects.toThrow(/LOCO API quota exceeded/);

      // Should be called only once (no retries)
      expect(fn).toHaveBeenCalledTimes(1);
    });

    it('should throw immediately for LOCO OAuth with free allocated quota exceeded message', async () => {
    ...
    it('should retry for LOCO OAuth with throttling message', async () => {
    ...
    it('should retry for LOCO OAuth with throttling error', async () => {
    ...
    it('should throw immediately for LOCO OAuth with quota message', async () => {
    ...
    it('should retry normal errors for LOCO OAuth (not quota-related)', async () => {
