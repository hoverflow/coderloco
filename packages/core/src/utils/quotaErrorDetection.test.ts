...
describe('quotaErrorDetection', () => {
  describe('islocoQuotaExceededError', () => {
    ...
    it('should not detect throttling errors as quota exceeded', () => {
      ...
      expect(islocoQuotaExceededError(error)).toBe(false);
    });
  ...
  describe('islocoThrottlingError', () => {
    ...
    it('should not detect throttling without 429 status in structured error', () => {
      ...
      expect(islocoThrottlingError(error)).toBe(false);
    });
