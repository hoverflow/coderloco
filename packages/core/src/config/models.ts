...
export const DEFAULT_loco_MODEL = 'coder-model';
export const DEFAULT_loco_FLASH_MODEL = 'coder-model';
export const DEFAULT_loco_EMBEDDING_MODEL = 'text-embedding-v4';
